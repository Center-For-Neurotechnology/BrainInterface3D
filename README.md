...
5. Coregister everything to T1w_acpc_dc_restore.nii with General Registration (ANTs) module, save each Transform
...
15. Convert the surface models into segmentations and then save them as nifty models for later DICOM conversion
